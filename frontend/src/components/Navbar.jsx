...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-b from-gray-900/90 to-black/60 border-b border-gray-800/60 backdrop-blur">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2">
            <img src="/glint.svg" alt="Glint" className="w-8 h-8" />
            <span className="text-xl font-bold gradient-text">Glint</span>
          </Link>
